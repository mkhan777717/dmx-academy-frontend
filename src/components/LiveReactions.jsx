  ...
  return (
    <div className="relative" ref={pickerRef}>
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute bottom-full mb-2 right-0 origin-bottom-right flex items-center gap-1.5 p-2 rounded-2xl bg-[var(--bg-card)]/90 backdrop-blur-md border border-[var(--border-primary)] border-[var(--border-primary)] shadow-2xl z-50"
          >
      ...
      <button
        ...
        className="flex items-center gap-1.5 px-3 py-2 rounded-xl border border-[var(--border-primary)] text-[10px] font-bold uppercase tracking-wide transition-all cursor-pointer hover:scale-105"
        style={{
